				...
				<div class="col-xs-12" id="button_area">
					<div class="button col-xs-2 col-xs-offset-6">
						<button type="button" class="btn btn-success btn-lg" 
								onclick="window.open('<%=request.getContextPath() %>/views/admin/product_add.jsp')">
								등록</button>
					</div>
					<div class="button col-xs-2">
						<button type="button" class="btn btn-warning btn-lg"
						onclick="window.open('<%=request.getContextPath() %>/views/admin/product_eddit.jsp')">수정</button>
					</div>
					<div class="button col-xs-2">
