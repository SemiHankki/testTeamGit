...
<input type="text" id="sample6_extraAddress" placeholder="참고항목" style="margin-right : 11px; margin-top : 5px">
<input type="text" id="sample6_detailAddress" placeholder="상세주소" style="margin-right : 11px; margin-top : 5px; margin-bottom : 10px; ">
