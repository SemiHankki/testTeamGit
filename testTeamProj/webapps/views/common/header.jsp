...
<body>
   ...
   <header class="main_menu_area">
            ...
            <div class="search_area col-xs-2">
               <div class="input-group">
                  <span class="input-group-btn">
                     <button class="btn btn-default" type="button" onclick="search_product();" style="margin-top: 2px;">Go!</button>
      ...
      function search_product(){
         location.href="<%=request.getContextPath()%>/productSearch.ps?con="+$('#product_search').val();
      }
   </script>
   </header>
