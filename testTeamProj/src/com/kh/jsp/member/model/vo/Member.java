...
//	생성자
	...
	public Member(String userId, String userPwd, String userName, String userPhone,
			String userEmail, String userAddress, String userBirth) {
		super();
		this.userId = userId;
	...
	public Member(String userId, int userNo, int userPoint, String userPwd, String userName, String userPhone,
			String userEmail, String userBirth, String userAddress, String enrollDate) {
		super();
		this.userId = userId;
		this.userNo = userNo;
